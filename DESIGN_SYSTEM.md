...
| `sb-screen` | Full-height screen root container — flex column, 100dvh, surface background, positioned; outline-offset for inset drag indicators. | `v3/src/styles/tokens.css` |
